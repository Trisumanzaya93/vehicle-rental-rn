  ...
  return (
    ...
    <View style={{backgroundColor:"white"}}>
       <View
        ...
        <View style={{width:"100%",justifyContent:"center",alignItems:"center"}}>
            <Text style={{fontSize:20,fontWeight:"bold",color:"black"}}>Payment Code :</Text>
            <Text style={{fontSize:36,fontWeight:"bold",color:"black"}}>{reservation.paymentCode}</Text>
            ...
            <Text style={{fontSize:24,fontWeight:"bold",color:"red"}}>1:59:34</Text>
            <Text style={{fontSize:16,fontWeight:"400",marginTop:10}}>Bank account information :</Text>
            <Text style={{fontSize:24,fontWeight:"bold", color:"black",marginTop:10}}>0290-90203-345-2</Text>
            ...
            <Text style={{fontSize:16,fontWeight:"bold"}}>Booking code : <Text style={{fontSize:16,fontWeight:"bold",color:'green'}}>{reservation.bookingCode}</Text></Text>
    ...
    borderRadius: 10,}} >
            <Text style={{fontSize:15 ,fontWeight:"bold", color:"black"}}>Copy Payment & Booking Code</Text>
          </TouchableOpacity>
        </View>
